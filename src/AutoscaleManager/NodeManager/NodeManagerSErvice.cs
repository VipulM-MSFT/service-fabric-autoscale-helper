namespace NodeManager
{
    ...
    internal class NodeManagerService : ActorService
    {
        ...
        {
            this.nodeManagerSettings = new NodeManagerSettings(FabricRuntime.GetActivationContext().GetConfigurationPackageObject(this.configurationPackageName).Settings);
        }
